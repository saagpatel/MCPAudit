...
- Evidence-to-enforcement: an experimental fixture-only workflow pinned to
  `agent-governance-toolkit-core==4.1.0`. Separate observed-evidence,
  recommendation, approved-intent, and effective-state contracts support a
  narrow program-owned synthetic allow/deny/approval compatibility slice.
